...
describe('useCache', () => {
  ...
  describe('Caching Behavior', () => {
    ...
    it('returns stale data while revalidating', async () => {
      const fetcher = jest.fn().mockResolvedValueOnce('initial').mockResolvedValueOnce('updated');
  ...
  describe('Cache Options', () => {
    it('respects TTL option', async () => {
      ...
      const { result } = renderHook(() => useCache('ttl-key', fetcher, { ttl: 1000 }));
    ...
    it('calls onSuccess callback', async () => {
      ...
      renderHook(() => useCache('success-key', fetcher, { onSuccess }));
    ...
    it('calls onError callback', async () => {
      ...
      renderHook(() => useCache('error-callback-key', fetcher, { onError }));
  ...
  describe('Mutate Function', () => {
    ...
    it('mutates data with updater function', async () => {
      ...
      const { result } = renderHook(() => useCache<{ count: number }>('updater-key', fetcher));
...
describe('useCacheList', () => {
  ...
  it('fetches paginated data', async () => {
    ...
    const { result } = renderHook(() => useCacheList('list-key', fetcher, { pageSize: 10 }));
  ...
  it('loads more data', async () => {
    ...
    const { result } = renderHook(() => useCacheList('list-more', fetcher, { pageSize: 2 }));
  ...
  it('detects no more data', async () => {
    ...
    const { result } = renderHook(() => useCacheList('list-end', fetcher, { pageSize: 10 }));
  ...
  it('resets list data', async () => {
    ...
    const { result } = renderHook(() => useCacheList('list-reset', fetcher, { pageSize: 1 }));
