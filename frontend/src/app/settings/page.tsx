  ...
  return (
    <div className="p-6 bg-white dark:bg-dark-card rounded-xl border border-gray-200 dark:border-gray-700">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Senha</h3>
...
function TwoFactorAuth() {
  ...
  const handleVerifyAndEnable = async () => {
    ...
    try {
      const { backupCodes: codes } = await userService.enable2FA(
        setupData!.secret,
        verificationCode
      );
      ...
      <div className="p-6 bg-white dark:bg-dark-card rounded-xl border border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          ...
          {isEnabled ? (
            ...
            <Button onClick={handleStartSetup} isLoading={isProcessing}>
              Ativar
            </Button>
          )}
        </div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg">
            <p className="text-yellow-800 dark:text-yellow-300 text-sm">
              <strong>Importante:</strong> Salve estes códigos em um lugar seguro. Cada código pode
              ser usado apenas uma vez para acessar sua conta se você perder acesso ao seu
        ...
        <div className="space-y-4">
          <div className="p-4 bg-red-100 dark:bg-red-900/30 rounded-lg">
            <p className="text-red-800 dark:text-red-300 text-sm">
              <strong>Atenção:</strong> Desativar a autenticação de dois fatores reduzirá a
    ...
    <>
      ...
      >
        <div className="space-y-4">
          <div className="p-4 bg-red-100 dark:bg-red-900/30 rounded-lg">
            <p className="text-red-800 dark:text-red-300 text-sm">
              <strong>Esta ação é irreversível!</strong> Todos os seus dados, mensagens e
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex gap-4 mb-8 border-b border-gray-200 dark:border-gray-700 pb-4">
          ...
          <span className="text-primary-600 dark:text-primary-400 font-medium">Segurança</span>
        </nav>
