        ...
        <div className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-md rounded-lg bg-white p-4 shadow-lg dark:bg-gray-800">
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Acesse mais rápido direto da home</p>
                </div>
            </div>
            <div className="mt-4 flex gap-2">
                <button onClick={handleDismiss} className="flex-1 rounded-lg px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">Agora não</button>
                <button onClick={handleInstall} className="flex-1 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/90">Instalar</button>
            </div>
        </div>
    );
}
...
export function UpdateAvailable() {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50 rounded-lg bg-primary p-4 text-white shadow-lg">
            ...
            <button onClick={update} className="rounded bg-white px-4 py-2 text-sm font-medium text-primary hover:bg-gray-100">Atualizar agora</button>
        </div>
    );
}
