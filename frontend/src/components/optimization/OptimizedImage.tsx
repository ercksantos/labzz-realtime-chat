...
export function AvatarImage({
  ...
  return (
    <div
      className={cn('relative overflow-hidden rounded-full', avatarSizeClasses[size], className)}
    >
      <Image
        src={src}
        alt={alt}
...
export function BackgroundImage({
  ...
  return (
    <div className={cn('relative overflow-hidden', className)}>
      <Image src={src} alt={alt} fill className="object-cover" priority={false} quality={75} />
      {overlay && (
        <div
